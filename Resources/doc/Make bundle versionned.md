...
class MyBundle extends VersionnedBundle
{
    public function __construct()
    {
        ...
        # a bundle not installed and required to be throws a kujaff\VersionsBundle\Exception\VersionException at bundle boot
        ...
        # a bundle not updated and required to be throws a kujaff\VersionsBundle\Exception\VersionException at bundle boot
